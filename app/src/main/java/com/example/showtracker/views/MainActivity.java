...
import static com.example.showtracker.views.AddEditActivity.*;
...
public class MainActivity extends BaseListActivity
    ...
    public void onListClick(@NonNull ListWithShows list) {
        ...
        intent.putExtra(ListOfShows.class.getSimpleName(), list.list);
    ...
    @Override
    public boolean onItemMoved(@NonNull ListOfShows toMove, @NonNull ListOfShows target) {
...
//                    result from activity to edit an existing list
                    ...
                    ListOfShows list = (ListOfShows) data.getSerializableExtra(ITEM_TO_EDIT);
                    list.name = data.getStringExtra(EXTRA_REPLY);
                    viewModel.renameList(list);

                } else {
//                    result from activity to create a new list
                    ListOfShows newList = new ListOfShows(data.getStringExtra(EXTRA_REPLY));
    ...
    private void editSelectedList() {
        ...
        ListOfShows list = this.adapter.findListById(listId);
