...
import static com.example.showtracker.screens.common.activities.BaseListActivity.SORT_BY_CUSTOM;
import static com.example.showtracker.screens.common.activities.BaseListActivity.SORT_BY_NAME;
import static com.example.showtracker.screens.lists.MainActivity.LIST_SORT_MODE;
...
//    private List<ListEntity> selection;
    ...
    public interface ListsRVEventListener {
        ...
        boolean onItemMoved(@NonNull ListEntity toMove, @NonNull ListEntity target);
    }
    ...
    public void onDrop(int fromPosition, int toPosition) {
        ListEntity toMove = this.lists.get(fromPosition).list;
        ListEntity target = this.lists.get(toPosition).list;
...
//    public void setSelection(List<ListEntity> selection) {
//        Log.d(TAG, "setSelection: starts");
//        this.selection = selection;
//    }

    public ListEntity findListById(String listId) {
